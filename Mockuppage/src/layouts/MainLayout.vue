...
<q-toolbar class="q-gutter-md">
  ...
  <div class="mobile-header lt-sm full-width">
    ...
    <div class="text-center">
      <div class="text-h6 text-bold text-secondary">Conservation Documentation</div>
  ...
  <div class="desktop-header gt-xs row items-center no-wrap full-width" style="justify-content: space-between;">
    ...
    <q-toolbar-title class="text-center">
      <div class="column items-center">
        <div class="text-h5 text-bold header-title text-secondary">Conservation Documentation</div>
